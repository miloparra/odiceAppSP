...
useHead({
  ...
  meta: [
    ...
    { property: 'og:url', content: 'https://www.odice-immigration.com/#blog' },
...
<template>
  <section id="blog" class="bg-white scroll-mt-16 px-5 xl:px-60 pt-10 pb-25">
    <div class="px-10 lg:px-5 py-10 space-y-2">
        <div class="font-semibold text-4xl lg:text-5xl text-[#6c6bc1]">
            Blog
        </div>
        <div class="xl:w-150 text-[#200c4f] font-medium lg:text-2xl whitespace-pre-line">
            Retrouvez ici tous mes nouveaux articles.
        </div>
    </div>
